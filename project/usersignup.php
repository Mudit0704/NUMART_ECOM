			...
			<form name="frm2" action="processUsersignup.php" method="post">
				<div class="form-row">
					<div class="col-md-6">
						...
						<input type="text" class="form-control " id="validationServer01" placeholder="Name" name="ntxt" required>
					</div>
					<div class="col-md-6">
				...
				<div class="form-row">
					<div class="col-md-6">
						...
						<input type="Password" class="form-control " id="pass" name="p1txt" placeholder="Password" maxlength="255" required>
					</div>
					<div class="col-md-6">
				...
				<div class="form-row">
					<div class="form-group col-md-12">
						...
						<textarea class="form-control" id="exampleFormControlTextarea1" name="adtxt" rows="5" cols="50" maxlength="5000"></textarea>
					</div>
				</div>
