...
<body>
    ...
    <div class="container" style="margin: 0 auto;margin-top: 3em;max-width: 60%">
        <div class="jumbotron" style="background-color: #44a08d;">
            <form name="frm1" action="processBrandUpdate.php" method="post">
                <div class="form-row">
                    <div class="col-md-12">
                    	<input type="hidden" name="prtxt" value="<?php echo $row[0] ?>"/>
                        <label for="validationServer01" style="color: white;">Enter Brand name</label>
                        <input type="text" class="form-control " id="validationServer01"  name="btxt" value="<?php echo $row[1] ?>" required>
                    </div>
                </div>
